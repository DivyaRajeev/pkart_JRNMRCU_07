...
public class CustomerDaoImpl implements ICustomerDao{
	...
	public ArrayList<Product> purchaseProduct() {
		...
		Product p1 = new Product(1,"Medicine 1", 1200.00d, 1, "12-09-2018", "09-12-2023");
		productlist.add(p1);
		Product p2 = new Product(2,"Medicine 2", 350.00d, 1, "07-10-2017", "09-11-2022");
		productlist.add(p2);
		Product p3 = new Product(3,"Medicine 3", 958.00d, 1, "06-09-2017", "12-12-2021");
		productlist.add(p3);
		Product p4 = new Product(4,"Medicine 4", 750.00d, 1, "11-06-2019", "09-11-2022");
		productlist.add(p4);
		return productlist;
	}
