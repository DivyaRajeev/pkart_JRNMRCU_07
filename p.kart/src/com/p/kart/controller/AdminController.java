...
import com.p.kart.service.ICustomerService;
import com.p.kart.service.CustomerServiceImpl;
import com.p.kart.service.IProductService;
...
public class AdminController {
	...
	public AdminController() {
		...
		if (null == productService) {
			productService = new ProductServiceImpl();//creating object for product service class
		}
		if (null == customerService) {
			customerService = new CustomerServiceImpl(); //creating object for customer service class
		}
	}

	public void operations() {  //admin operations page method
